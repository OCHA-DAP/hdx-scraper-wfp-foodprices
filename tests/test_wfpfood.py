    ...
    def test_run(self, configuration, fixtures_dir, input_dir):
        with temp_dir('TestWFPFoodPrices', delete_on_success=True, delete_on_failure=False) as tempdir:
            with Download(user_agent='test') as downloader:
                ...
                wfp = WFPFood(configuration, None, retriever, None)
                ...
                assert showcase == {'name': 'wfp-food-prices-for-congo-showcase', 'title': 'Congo - Food Prices showcase', 'notes': 'Congo food prices data from World Food Programme displayed through VAM Economic Explorer',
                                    ...
                                    'tags': [{'name': 'commodities', 'vocabulary_id': 'b891512e-9516-4bf5-962a-7a289772a2a1'}, {'name': 'prices', 'vocabulary_id': 'b891512e-9516-4bf5-962a-7a289772a2a1'}, {'name': 'markets', 'vocabulary_id': 'b891512e-9516-4bf5-962a-7a289772a2a1'}, {'name': 'hxl', 'vocabulary_id': 'b891512e-9516-4bf5-962a-7a289772a2a1'}]}
                assert qc_indicators == [{'code': 'Brazzaville-Brazzaville-Total-Groundnuts (shelled)-KG-XAF', 'title': 'Price of Groundnuts (shelled) in Total', 'unit': 'US Dollars ($)',
                                          'description': 'Price of Groundnuts (shelled) ($/KG) in Brazzaville/Total', 'code_col': '#meta+code', 'value_col': '#value+usd', 'date_col': '#date'},
                                         {'code': 'Point-Noire-Pointe-Noire-Grand marché/Fond Ntié-Ntié/Nkouikou-Oil (vegetable)-L-XAF', 'title': 'Price of Oil (vegetable) in Grand marché/Fond Ntié-Ntié/Nkouikou', 'unit': 'US Dollars ($)',
                                          'description': 'Price of Oil (vegetable) ($/L) in Point-Noire/Pointe-Noire/Grand marché/Fond Ntié-Ntié/Nkouikou', 'code_col': '#meta+code', 'value_col': '#value+usd', 'date_col': '#date'},
                                         {'code': 'Pool-Kinkala-Kinkala-Rice (mixed, low quality)-KG-XAF', 'title': 'Price of Rice (mixed, low quality) in Kinkala', 'unit': 'US Dollars ($)',
                                          'description': 'Price of Rice (mixed, low quality) ($/KG) in Pool/Kinkala', 'code_col': '#meta+code', 'value_col': '#value+usd', 'date_col': '#date'}]
